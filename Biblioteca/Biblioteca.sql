...
(
	Cod_Biblioteca int not null primary key auto_increment,
...
(
	Cod_Escritor int not null primary key auto_increment,
	Pri_Nome varchar(50) not null,
	Ult_Nome varchar(50) not null
);
...
alter table livro
drop foreign key livro_fk_tipo_livro;
...
create index emprestimo_funcionario_cod_funcionario_cod_livro_cod_escritor
...
alter table emprestimo_Funcionario
add constraint emprestimo_funcionario_fk_livro_escritor
foreign key (cod_escritor)
references livro (cod_escritor);
...
create index emprestimo_cod_cliente_cod_livro_cod_escritor
...
add constraint emprestimo_fk_livro
    ...
    references Livro (Cod_Livro);
alter table emprestimo
add constraint emprestimo_fk_livro_escritor
foreign key (Cod_Escritor)
references livro (Cod_Escritor);