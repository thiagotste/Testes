...
<html lang="br">
    ...
    <section id="sec2">
        ...
        <br>
        <p><span class="spsec1">Área Administrativa</span><br>
            <span class="spsec2">Gerência o funcionamento da biblioteca.</span>
        </p>
        <nav class="navsec">
            <a class="asec6" href="ItemPainel?controle=9">Adicionar Classificação</a>
